...
public class SaveEmailAsynctask extends AsyncTask<Void, Integer, Void>{
	...
	String delearId,empId,customerId,callEndTime;
	ListView cusAttachmentListview;
	TextView cusAttachmentTextview;
	public SaveEmailAsynctask(Context context, String dealerId,String empId, String cusId, String callEndTime) {
	...
	protected void onPreExecute() {
		...
		try {
			...
			reqObj_data.put(Constants.SAVE_EMAIL_SENT_DATE, callEndTime);
			reqObj_data.put(Constants.SAVE_EMAIL_EMAIL_SUBJECT, Singleton.getInstance().getEmailSubject());
			reqObj_data.put(Constants.SAVE_EMAIL_EMAIL_BODY, Singleton.getInstance().getEmailBody());
	...
	protected Void doInBackground(Void... params) {
		responseJson = serviceHelper.jsonSendHTTPRequest(
				mRequestJson.toString(), Constants.SAVE_EMAIL_STATE,
	...
	protected void onPostExecute(Void result) {
		...
		if(responseJson != null){
			if (responseJson.has(Constants.SAVE_EMAIL_STATUS)) {
